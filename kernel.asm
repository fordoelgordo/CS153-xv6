...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 9f 6e 10 80 	movl   $0x80106e9f,(%esp)
...
80101225:	c7 04 24 b2 6e 10 80 	movl   $0x80106eb2,(%esp)
...
8010134d:	c7 04 24 c8 6e 10 80 	movl   $0x80106ec8,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 d8 6e 10 80 	movl   $0x80106ed8,(%esp)
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 42 75 10 80 	movl   $0x80107542,(%esp)
...
80102da7:	e8 c4 28 00 00       	call   80105670 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 65 39 00 00       	call   80106740 <switchkvm>
  seginit();
80102ddb:	e8 a0 38 00 00       	call   80106680 <seginit>
  lapicinit();
...
80102e25:	e8 56 38 00 00       	call   80106680 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 61 2b 00 00       	call   801059a0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 86 27 00 00       	call   801055d0 <tvinit>
  binit();         // buffer cache
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 c5 55 10 80 	movl   $0x801055c5,0x14(%eax)
...
80103705:	80 
80103706:	e8 65 31 00 00       	call   80106870 <inituvm>
  p->sz = PGSIZE;
...
80103809:	e8 a2 31 00 00       	call   801069b0 <allocuvm>
...
80103817:	e8 44 2f 00 00       	call   80106760 <switchuvm>
  return 0;
...
8010387e:	e8 9d 33 00 00       	call   80106c20 <copyuvm>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 a6 2d 00 00       	call   80106760 <switchuvm>
...
801039cb:	e8 3b 0c 00 00       	call   8010460b <swtch>
      switchkvm();
801039d0:	e8 6b 2d 00 00       	call   80106740 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103ab5:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103ab7:	0f 84 f0 00 00 00    	je     80103bad <exit+0x10d>
...
80103b92:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->exitstatus = status;
80103b99:	89 43 7c             	mov    %eax,0x7c(%ebx)
  sched();
80103b9c:	e8 5f fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103ba1:	c7 04 24 bd 73 10 80 	movl   $0x801073bd,(%esp)
80103ba8:	e8 b3 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bad:	c7 04 24 b0 73 10 80 	movl   $0x801073b0,(%esp)
80103bb4:	e8 a7 c7 ff ff       	call   80100360 <panic>
...
80103bcd:	e8 3e 07 00 00       	call   80104310 <acquire>
...
80103bea:	e8 91 07 00 00       	call   80104380 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 da 06 00 00       	call   80104310 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 42 07 00 00       	call   80104380 <release>
  p->chan = chan;
...
80103c5b:	e8 20 07 00 00       	call   80104380 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 a1 06 00 00       	jmp    80104310 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103cb9:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct proc *curproc = myproc();
80103cbc:	e8 df f9 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103cc1:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103cc8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cca:	e8 41 06 00 00       	call   80104310 <acquire>
    havekids = 0;
80103ccf:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103cd6:	eb 0b                	jmp    80103ce3 <wait+0x33>
...
80103cec:	74 53                	je     80103d41 <wait+0x91>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103d02:	74 19                	je     80103d1d <wait+0x6d>
80103d04:	8b 46 24             	mov    0x24(%esi),%eax
80103d07:	85 c0                	test   %eax,%eax
80103d09:	75 12                	jne    80103d1d <wait+0x6d>
...
80103d1b:	eb b2                	jmp    80103ccf <wait+0x1f>
      release(&ptable.lock);
80103d1d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d24:	e8 57 06 00 00       	call   80104380 <release>
      if (status != 0)
80103d29:	85 ff                	test   %edi,%edi
80103d2b:	74 07                	je     80103d34 <wait+0x84>
	*status = p->exitstatus;
80103d2d:	a1 d0 4d 11 80       	mov    0x80114dd0,%eax
80103d32:	89 07                	mov    %eax,(%edi)
      return -1;
80103d34:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103d39:	83 c4 1c             	add    $0x1c,%esp
80103d3c:	5b                   	pop    %ebx
80103d3d:	5e                   	pop    %esi
80103d3e:	5f                   	pop    %edi
80103d3f:	5d                   	pop    %ebp
80103d40:	c3                   	ret    
        kfree(p->kstack);
80103d41:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
80103d44:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103d47:	89 04 24             	mov    %eax,(%esp)
80103d4a:	e8 a1 e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103d4f:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103d52:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103d59:	89 04 24             	mov    %eax,(%esp)
80103d5c:	e8 5f 2d 00 00       	call   80106ac0 <freevm>
        release(&ptable.lock);
80103d61:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103d68:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103d6f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103d76:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103d7a:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103d81:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103d88:	e8 f3 05 00 00       	call   80104380 <release>
	if (status != 0)
80103d8d:	85 ff                	test   %edi,%edi
80103d8f:	74 0f                	je     80103da0 <wait+0xf0>
	  *status = p->exitstatus;
80103d91:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103d94:	89 07                	mov    %eax,(%edi)
}
80103d96:	83 c4 1c             	add    $0x1c,%esp
	return pid;
80103d99:	89 f0                	mov    %esi,%eax
}
80103d9b:	5b                   	pop    %ebx
80103d9c:	5e                   	pop    %esi
80103d9d:	5f                   	pop    %edi
...
80103da2:	eb 95                	jmp    80103d39 <wait+0x89>
...
80103dbc:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  struct proc *curproc = myproc();
80103dbf:	e8 dc f8 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103dc4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103dcb:	89 c7                	mov    %eax,%edi
  acquire(&ptable.lock);
80103dcd:	e8 3e 05 00 00       	call   80104310 <acquire>
80103dd2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    havekids = 0;
80103dd5:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dd7:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103ddc:	eb 0d                	jmp    80103deb <waitpid+0x3b>
80103dde:	66 90                	xchg   %ax,%ax
80103de0:	83 eb 80             	sub    $0xffffff80,%ebx
80103de3:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103de9:	73 25                	jae    80103e10 <waitpid+0x60>
      if(p->pid != pid)
80103deb:	8b 73 10             	mov    0x10(%ebx),%esi
80103dee:	39 d6                	cmp    %edx,%esi
80103df0:	75 ee                	jne    80103de0 <waitpid+0x30>
      if(p->state == ZOMBIE){
80103df2:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103df6:	74 50                	je     80103e48 <waitpid+0x98>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103df8:	83 eb 80             	sub    $0xffffff80,%ebx
80103dfb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103e01:	73 15                	jae    80103e18 <waitpid+0x68>
      havekids = 1;
80103e03:	b8 01 00 00 00       	mov    $0x1,%eax
80103e08:	eb e1                	jmp    80103deb <waitpid+0x3b>
80103e0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(!havekids || curproc->killed){
80103e10:	85 c0                	test   %eax,%eax
80103e12:	0f 84 92 00 00 00    	je     80103eaa <waitpid+0xfa>
80103e18:	8b 4f 24             	mov    0x24(%edi),%ecx
80103e1b:	85 c9                	test   %ecx,%ecx
80103e1d:	0f 85 87 00 00 00    	jne    80103eaa <waitpid+0xfa>
    if(options == 0) {
80103e23:	8b 45 10             	mov    0x10(%ebp),%eax
80103e26:	85 c0                	test   %eax,%eax
80103e28:	75 ab                	jne    80103dd5 <waitpid+0x25>
      sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103e2a:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103e31:	80 
80103e32:	89 3c 24             	mov    %edi,(%esp)
80103e35:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103e38:	e8 c3 fd ff ff       	call   80103c00 <sleep>
80103e3d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103e40:	eb 93                	jmp    80103dd5 <waitpid+0x25>
80103e42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
80103e48:	8b 43 08             	mov    0x8(%ebx),%eax
80103e4b:	89 04 24             	mov    %eax,(%esp)
80103e4e:	e8 9d e4 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
...
80103e60:	e8 5b 2c 00 00       	call   80106ac0 <freevm>
        release(&ptable.lock);
80103e65:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
...
80103e8c:	e8 ef 04 00 00       	call   80104380 <release>
	if (status != 0)
80103e91:	8b 7d 0c             	mov    0xc(%ebp),%edi
80103e94:	85 ff                	test   %edi,%edi
80103e96:	74 08                	je     80103ea0 <waitpid+0xf0>
	  *status = p->exitstatus;
80103e98:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103e9b:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103e9e:	89 01                	mov    %eax,(%ecx)
}
80103ea0:	83 c4 1c             	add    $0x1c,%esp
80103ea3:	89 f0                	mov    %esi,%eax
80103ea5:	5b                   	pop    %ebx
80103ea6:	5e                   	pop    %esi
80103ea7:	5f                   	pop    %edi
80103ea8:	5d                   	pop    %ebp
80103ea9:	c3                   	ret    
      release(&ptable.lock);
80103eaa:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80103eb1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103eb6:	e8 c5 04 00 00       	call   80104380 <release>
      return -1;
80103ebb:	eb e3                	jmp    80103ea0 <waitpid+0xf0>
...
80103fb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103fb8:	c7 04 24 5b 77 10 80 	movl   $0x8010775b,(%esp)
...
80103fda:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103fdd:	ba e0 73 10 80       	mov    $0x801073e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103fe2:	77 11                	ja     80103ff5 <procdump+0x55>
80103fe4:	8b 14 85 40 74 10 80 	mov    -0x7fef8bc0(,%eax,4),%edx
      state = "???";
80103feb:	b8 e0 73 10 80       	mov    $0x801073e0,%eax
...
80104000:	c7 04 24 e4 73 10 80 	movl   $0x801073e4,(%esp)
...
80104049:	c7 04 24 21 6e 10 80 	movl   $0x80106e21,(%esp)
...
8010407a:	c7 44 24 04 58 74 10 	movl   $0x80107458,0x4(%esp)
80104081:	80 
...
801040d7:	e8 24 fb ff ff       	call   80103c00 <sleep>
  while (lk->locked) {
...
801042a9:	c3                   	ret    
    panic("popcli");
801042aa:	c7 04 24 7a 74 10 80 	movl   $0x8010747a,(%esp)
801042b1:	e8 aa c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801042b6:	c7 04 24 63 74 10 80 	movl   $0x80107463,(%esp)
...
80104364:	c3                   	ret    
    panic("acquire");
80104365:	c7 04 24 81 74 10 80 	movl   $0x80107481,(%esp)
...
801043b2:	e9 a9 fe ff ff       	jmp    80104260 <popcli>
    panic("release");
801043b7:	c7 04 24 89 74 10 80 	movl   $0x80107489,(%esp)
...
801047ad:	8b 14 85 c0 74 10 80 	mov    -0x7fef8b40(,%eax,4),%edx
...
801047d6:	c7 04 24 91 74 10 80 	movl   $0x80107491,(%esp)
...
80104960:	c7 44 24 04 38 75 10 	movl   $0x80107538,0x4(%esp)
80104967:	80 
...
8010497b:	c7 44 24 04 37 75 10 	movl   $0x80107537,0x4(%esp)
80104982:	80 
...
80104991:	79 89                	jns    8010491c <create+0xdc>
      panic("create dots");
80104993:	c7 04 24 2b 75 10 80 	movl   $0x8010752b,(%esp)
8010499a:	e8 c1 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010499f:	c7 04 24 3a 75 10 80 	movl   $0x8010753a,(%esp)
801049a6:	e8 b5 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
801049ab:	c7 04 24 1c 75 10 80 	movl   $0x8010751c,(%esp)
...
80104d51:	c7 44 24 04 38 75 10 	movl   $0x80107538,0x4(%esp)
80104d58:	80 
...
80104d69:	c7 44 24 04 37 75 10 	movl   $0x80107537,0x4(%esp)
80104d70:	80 
...
80104ebd:	c7 04 24 5c 75 10 80 	movl   $0x8010755c,(%esp)
80104ec4:	e8 97 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104ec9:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
80104ed0:	e8 8b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104ed5:	c7 04 24 4a 75 10 80 	movl   $0x8010754a,(%esp)
...
80105364:	e8 57 f3 ff ff       	call   801046c0 <argint>
80105369:	85 c0                	test   %eax,%eax
8010536b:	78 13                	js     80105380 <sys_exit+0x30>
    return -1;
  exit(n);
8010536d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105370:	89 04 24             	mov    %eax,(%esp)
80105373:	e8 28 e7 ff ff       	call   80103aa0 <exit>
  return 0;
...
801053ac:	e8 3f f3 ff ff       	call   801046f0 <argptr>
801053b1:	85 c0                	test   %eax,%eax
801053b3:	78 13                	js     801053c8 <sys_wait+0x38>
    return -1;
  return wait(n);
801053b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053b8:	89 04 24             	mov    %eax,(%esp)
801053bb:	e8 f0 e8 ff ff       	call   80103cb0 <wait>
}
801053c0:	c9                   	leave  
801053c1:	c3                   	ret    
...
801053e4:	e8 d7 f2 ff ff       	call   801046c0 <argint>
801053e9:	85 c0                	test   %eax,%eax
801053eb:	78 3b                	js     80105428 <sys_waitpid+0x58>
    return -1;
  int* status;
  if(argptr(1, (void*) &status, sizeof(*status)) < 0)
801053ed:	8d 45 f4             	lea    -0xc(%ebp),%eax
801053f0:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801053f7:	00 
801053f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801053fc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105403:	e8 e8 f2 ff ff       	call   801046f0 <argptr>
80105408:	85 c0                	test   %eax,%eax
8010540a:	78 1c                	js     80105428 <sys_waitpid+0x58>
    return -1;
  return waitpid(pid, status, 0);
8010540c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010540f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105416:	00 
80105417:	89 44 24 04          	mov    %eax,0x4(%esp)
8010541b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010541e:	89 04 24             	mov    %eax,(%esp)
80105421:	e8 8a e9 ff ff       	call   80103db0 <waitpid>
}
80105426:	c9                   	leave  
80105427:	c3                   	ret    
    return -1;
...
80105444:	e8 77 f2 ff ff       	call   801046c0 <argint>
80105449:	85 c0                	test   %eax,%eax
8010544b:	78 13                	js     80105460 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010544d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105450:	89 04 24             	mov    %eax,(%esp)
80105453:	e8 c8 ea ff ff       	call   80103f20 <kill>
}
80105458:	c9                   	leave  
80105459:	c3                   	ret    
...
80105473:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105476:	e8 25 e2 ff ff       	call   801036a0 <myproc>
...
8010549c:	78 22                	js     801054c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010549e:	e8 fd e1 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
801054a3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
801054a6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801054a8:	89 14 24             	mov    %edx,(%esp)
801054ab:	e8 30 e3 ff ff       	call   801037e0 <growproc>
801054b0:	85 c0                	test   %eax,%eax
801054b2:	78 0c                	js     801054c0 <sys_sbrk+0x40>
    return -1;
  return addr;
801054b4:	89 d8                	mov    %ebx,%eax
}
801054b6:	83 c4 24             	add    $0x24,%esp
801054b9:	5b                   	pop    %ebx
801054ba:	5d                   	pop    %ebp
801054bb:	c3                   	ret    
...
801054c5:	eb ef                	jmp    801054b6 <sys_sbrk+0x36>
...
801054e5:	e8 d6 f1 ff ff       	call   801046c0 <argint>
801054ea:	85 c0                	test   %eax,%eax
801054ec:	78 7e                	js     8010556c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801054ee:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801054f5:	e8 16 ee ff ff       	call   80104310 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801054fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801054fd:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105510:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105517:	80 
80105518:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010551f:	e8 dc e6 ff ff       	call   80103c00 <sleep>
  while(ticks - ticks0 < n){
80105524:	a1 a0 55 11 80       	mov    0x801155a0,%eax
80105529:	29 d8                	sub    %ebx,%eax
8010552b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010552e:	73 28                	jae    80105558 <sys_sleep+0x88>
    if(myproc()->killed){
80105530:	e8 6b e1 ff ff       	call   801036a0 <myproc>
80105535:	8b 40 24             	mov    0x24(%eax),%eax
80105538:	85 c0                	test   %eax,%eax
8010553a:	74 d4                	je     80105510 <sys_sleep+0x40>
      release(&tickslock);
8010553c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105543:	e8 38 ee ff ff       	call   80104380 <release>
      return -1;
...
80105554:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105558:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010555f:	e8 1c ee ff ff       	call   80104380 <release>
}
...
8010558e:	e8 7d ed ff ff       	call   80104310 <acquire>
  xticks = ticks;
80105593:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105599:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055a0:	e8 db ed ff ff       	call   80104380 <release>
  return xticks;
}
...
801055ae:	06                   	push   %es
  pushl %fs
801055af:	0f a0                	push   %fs
  pushl %gs
801055b1:	0f a8                	push   %gs
  pushal
801055b3:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801055b4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801055b8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801055ba:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801055bc:	54                   	push   %esp
  call trap
801055bd:	e8 de 00 00 00       	call   801056a0 <trap>
  addl $4, %esp
801055c2:	83 c4 04             	add    $0x4,%esp
...
801055c5:	61                   	popa   
  popl %gs
801055c6:	0f a9                	pop    %gs
  popl %fs
801055c8:	0f a1                	pop    %fs
  popl %es
801055ca:	07                   	pop    %es
  popl %ds
801055cb:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801055cc:	83 c4 08             	add    $0x8,%esp
  iret
801055cf:	cf                   	iret   
...
80105656:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010565c:	e8 3f eb ff ff       	call   801041a0 <initlock>
}
80105661:	c9                   	leave  
80105662:	c3                   	ret    
...
801056c8:	e8 d3 df ff ff       	call   801036a0 <myproc>
...
801056ec:	e8 8f df ff ff       	call   80103680 <cpuid>
...
80105704:	e8 97 df ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
8010573e:	e8 0d af ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
80105743:	e8 58 df ff ff       	call   801036a0 <myproc>
...
80105765:	e8 36 df ff ff       	call   801036a0 <myproc>
8010576a:	85 c0                	test   %eax,%eax
8010576c:	74 0d                	je     8010577b <trap+0xdb>
8010576e:	66 90                	xchg   %ax,%ax
80105770:	e8 2b df ff ff       	call   801036a0 <myproc>
...
80105779:	74 55                	je     801057d0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010577b:	e8 20 df ff ff       	call   801036a0 <myproc>
80105780:	85 c0                	test   %eax,%eax
80105782:	74 1d                	je     801057a1 <trap+0x101>
80105784:	e8 17 df ff ff       	call   801036a0 <myproc>
...
801057c4:	e8 d7 e2 ff ff       	call   80103aa0 <exit>
...
80105810:	e8 2b 02 00 00       	call   80105a40 <uartintr>
    lapiceoi();
80105815:	e8 66 cf ff ff       	call   80102780 <lapiceoi>
    break;
...
80105827:	e8 54 de ff ff       	call   80103680 <cpuid>
...
80105977:	e8 24 ce ff ff       	call   801027a0 <microdelay>
...
80105a14:	e8 97 c8 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105a56:	6a 00                	push   $0x0
  jmp alltraps
80105a58:	e9 50 fb ff ff       	jmp    801055ad <alltraps>
...
80105a5f:	6a 01                	push   $0x1
  jmp alltraps
80105a61:	e9 47 fb ff ff       	jmp    801055ad <alltraps>
...
80105a68:	6a 02                	push   $0x2
  jmp alltraps
80105a6a:	e9 3e fb ff ff       	jmp    801055ad <alltraps>
...
80105a71:	6a 03                	push   $0x3
  jmp alltraps
80105a73:	e9 35 fb ff ff       	jmp    801055ad <alltraps>
...
80105a7a:	6a 04                	push   $0x4
  jmp alltraps
80105a7c:	e9 2c fb ff ff       	jmp    801055ad <alltraps>
...
80105a83:	6a 05                	push   $0x5
  jmp alltraps
80105a85:	e9 23 fb ff ff       	jmp    801055ad <alltraps>
...
80105a8c:	6a 06                	push   $0x6
  jmp alltraps
80105a8e:	e9 1a fb ff ff       	jmp    801055ad <alltraps>
...
80105a95:	6a 07                	push   $0x7
  jmp alltraps
80105a97:	e9 11 fb ff ff       	jmp    801055ad <alltraps>
...
80105a9c:	6a 08                	push   $0x8
  jmp alltraps
80105a9e:	e9 0a fb ff ff       	jmp    801055ad <alltraps>
...
80105aa5:	6a 09                	push   $0x9
  jmp alltraps
80105aa7:	e9 01 fb ff ff       	jmp    801055ad <alltraps>
...
80105aac:	6a 0a                	push   $0xa
  jmp alltraps
80105aae:	e9 fa fa ff ff       	jmp    801055ad <alltraps>
...
80105ab3:	6a 0b                	push   $0xb
  jmp alltraps
80105ab5:	e9 f3 fa ff ff       	jmp    801055ad <alltraps>
...
80105aba:	6a 0c                	push   $0xc
  jmp alltraps
80105abc:	e9 ec fa ff ff       	jmp    801055ad <alltraps>
...
80105ac1:	6a 0d                	push   $0xd
  jmp alltraps
80105ac3:	e9 e5 fa ff ff       	jmp    801055ad <alltraps>
...
80105ac8:	6a 0e                	push   $0xe
  jmp alltraps
80105aca:	e9 de fa ff ff       	jmp    801055ad <alltraps>
...
80105ad1:	6a 0f                	push   $0xf
  jmp alltraps
80105ad3:	e9 d5 fa ff ff       	jmp    801055ad <alltraps>
...
80105ada:	6a 10                	push   $0x10
  jmp alltraps
80105adc:	e9 cc fa ff ff       	jmp    801055ad <alltraps>
...
80105ae1:	6a 11                	push   $0x11
  jmp alltraps
80105ae3:	e9 c5 fa ff ff       	jmp    801055ad <alltraps>
...
80105aea:	6a 12                	push   $0x12
  jmp alltraps
80105aec:	e9 bc fa ff ff       	jmp    801055ad <alltraps>
...
80105af3:	6a 13                	push   $0x13
  jmp alltraps
80105af5:	e9 b3 fa ff ff       	jmp    801055ad <alltraps>
...
80105afc:	6a 14                	push   $0x14
  jmp alltraps
80105afe:	e9 aa fa ff ff       	jmp    801055ad <alltraps>
...
80105b05:	6a 15                	push   $0x15
  jmp alltraps
80105b07:	e9 a1 fa ff ff       	jmp    801055ad <alltraps>
...
80105b0e:	6a 16                	push   $0x16
  jmp alltraps
80105b10:	e9 98 fa ff ff       	jmp    801055ad <alltraps>
...
80105b17:	6a 17                	push   $0x17
  jmp alltraps
80105b19:	e9 8f fa ff ff       	jmp    801055ad <alltraps>
...
80105b20:	6a 18                	push   $0x18
  jmp alltraps
80105b22:	e9 86 fa ff ff       	jmp    801055ad <alltraps>
...
80105b29:	6a 19                	push   $0x19
  jmp alltraps
80105b2b:	e9 7d fa ff ff       	jmp    801055ad <alltraps>
...
80105b32:	6a 1a                	push   $0x1a
  jmp alltraps
80105b34:	e9 74 fa ff ff       	jmp    801055ad <alltraps>
...
80105b3b:	6a 1b                	push   $0x1b
  jmp alltraps
80105b3d:	e9 6b fa ff ff       	jmp    801055ad <alltraps>
...
80105b44:	6a 1c                	push   $0x1c
  jmp alltraps
80105b46:	e9 62 fa ff ff       	jmp    801055ad <alltraps>
...
80105b4d:	6a 1d                	push   $0x1d
  jmp alltraps
80105b4f:	e9 59 fa ff ff       	jmp    801055ad <alltraps>
...
80105b56:	6a 1e                	push   $0x1e
  jmp alltraps
80105b58:	e9 50 fa ff ff       	jmp    801055ad <alltraps>
...
80105b5f:	6a 1f                	push   $0x1f
  jmp alltraps
80105b61:	e9 47 fa ff ff       	jmp    801055ad <alltraps>
...
80105b68:	6a 20                	push   $0x20
  jmp alltraps
80105b6a:	e9 3e fa ff ff       	jmp    801055ad <alltraps>
...
80105b71:	6a 21                	push   $0x21
  jmp alltraps
80105b73:	e9 35 fa ff ff       	jmp    801055ad <alltraps>
...
80105b7a:	6a 22                	push   $0x22
  jmp alltraps
80105b7c:	e9 2c fa ff ff       	jmp    801055ad <alltraps>
...
80105b83:	6a 23                	push   $0x23
  jmp alltraps
80105b85:	e9 23 fa ff ff       	jmp    801055ad <alltraps>
...
80105b8c:	6a 24                	push   $0x24
  jmp alltraps
80105b8e:	e9 1a fa ff ff       	jmp    801055ad <alltraps>
...
80105b95:	6a 25                	push   $0x25
  jmp alltraps
80105b97:	e9 11 fa ff ff       	jmp    801055ad <alltraps>
...
80105b9e:	6a 26                	push   $0x26
  jmp alltraps
80105ba0:	e9 08 fa ff ff       	jmp    801055ad <alltraps>
...
80105ba7:	6a 27                	push   $0x27
  jmp alltraps
80105ba9:	e9 ff f9 ff ff       	jmp    801055ad <alltraps>
...
80105bb0:	6a 28                	push   $0x28
  jmp alltraps
80105bb2:	e9 f6 f9 ff ff       	jmp    801055ad <alltraps>
...
80105bb9:	6a 29                	push   $0x29
  jmp alltraps
80105bbb:	e9 ed f9 ff ff       	jmp    801055ad <alltraps>
...
80105bc2:	6a 2a                	push   $0x2a
  jmp alltraps
80105bc4:	e9 e4 f9 ff ff       	jmp    801055ad <alltraps>
...
80105bcb:	6a 2b                	push   $0x2b
  jmp alltraps
80105bcd:	e9 db f9 ff ff       	jmp    801055ad <alltraps>
...
80105bd4:	6a 2c                	push   $0x2c
  jmp alltraps
80105bd6:	e9 d2 f9 ff ff       	jmp    801055ad <alltraps>
...
80105bdd:	6a 2d                	push   $0x2d
  jmp alltraps
80105bdf:	e9 c9 f9 ff ff       	jmp    801055ad <alltraps>
...
80105be6:	6a 2e                	push   $0x2e
  jmp alltraps
80105be8:	e9 c0 f9 ff ff       	jmp    801055ad <alltraps>
...
80105bef:	6a 2f                	push   $0x2f
  jmp alltraps
80105bf1:	e9 b7 f9 ff ff       	jmp    801055ad <alltraps>
...
80105bf8:	6a 30                	push   $0x30
  jmp alltraps
80105bfa:	e9 ae f9 ff ff       	jmp    801055ad <alltraps>
...
80105c01:	6a 31                	push   $0x31
  jmp alltraps
80105c03:	e9 a5 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c0a:	6a 32                	push   $0x32
  jmp alltraps
80105c0c:	e9 9c f9 ff ff       	jmp    801055ad <alltraps>
...
80105c13:	6a 33                	push   $0x33
  jmp alltraps
80105c15:	e9 93 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c1c:	6a 34                	push   $0x34
  jmp alltraps
80105c1e:	e9 8a f9 ff ff       	jmp    801055ad <alltraps>
...
80105c25:	6a 35                	push   $0x35
  jmp alltraps
80105c27:	e9 81 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c2e:	6a 36                	push   $0x36
  jmp alltraps
80105c30:	e9 78 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c37:	6a 37                	push   $0x37
  jmp alltraps
80105c39:	e9 6f f9 ff ff       	jmp    801055ad <alltraps>
...
80105c40:	6a 38                	push   $0x38
  jmp alltraps
80105c42:	e9 66 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c49:	6a 39                	push   $0x39
  jmp alltraps
80105c4b:	e9 5d f9 ff ff       	jmp    801055ad <alltraps>
...
80105c52:	6a 3a                	push   $0x3a
  jmp alltraps
80105c54:	e9 54 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c5b:	6a 3b                	push   $0x3b
  jmp alltraps
80105c5d:	e9 4b f9 ff ff       	jmp    801055ad <alltraps>
...
80105c64:	6a 3c                	push   $0x3c
  jmp alltraps
80105c66:	e9 42 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c6d:	6a 3d                	push   $0x3d
  jmp alltraps
80105c6f:	e9 39 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c76:	6a 3e                	push   $0x3e
  jmp alltraps
80105c78:	e9 30 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c7f:	6a 3f                	push   $0x3f
  jmp alltraps
80105c81:	e9 27 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c88:	6a 40                	push   $0x40
  jmp alltraps
80105c8a:	e9 1e f9 ff ff       	jmp    801055ad <alltraps>
...
80105c91:	6a 41                	push   $0x41
  jmp alltraps
80105c93:	e9 15 f9 ff ff       	jmp    801055ad <alltraps>
...
80105c9a:	6a 42                	push   $0x42
  jmp alltraps
80105c9c:	e9 0c f9 ff ff       	jmp    801055ad <alltraps>
...
80105ca3:	6a 43                	push   $0x43
  jmp alltraps
80105ca5:	e9 03 f9 ff ff       	jmp    801055ad <alltraps>
...
80105cac:	6a 44                	push   $0x44
  jmp alltraps
80105cae:	e9 fa f8 ff ff       	jmp    801055ad <alltraps>
...
80105cb5:	6a 45                	push   $0x45
  jmp alltraps
80105cb7:	e9 f1 f8 ff ff       	jmp    801055ad <alltraps>
...
80105cbe:	6a 46                	push   $0x46
  jmp alltraps
80105cc0:	e9 e8 f8 ff ff       	jmp    801055ad <alltraps>
...
80105cc7:	6a 47                	push   $0x47
  jmp alltraps
80105cc9:	e9 df f8 ff ff       	jmp    801055ad <alltraps>
...
80105cd0:	6a 48                	push   $0x48
  jmp alltraps
80105cd2:	e9 d6 f8 ff ff       	jmp    801055ad <alltraps>
...
80105cd9:	6a 49                	push   $0x49
  jmp alltraps
80105cdb:	e9 cd f8 ff ff       	jmp    801055ad <alltraps>
...
80105ce2:	6a 4a                	push   $0x4a
  jmp alltraps
80105ce4:	e9 c4 f8 ff ff       	jmp    801055ad <alltraps>
...
80105ceb:	6a 4b                	push   $0x4b
  jmp alltraps
80105ced:	e9 bb f8 ff ff       	jmp    801055ad <alltraps>
...
80105cf4:	6a 4c                	push   $0x4c
  jmp alltraps
80105cf6:	e9 b2 f8 ff ff       	jmp    801055ad <alltraps>
...
80105cfd:	6a 4d                	push   $0x4d
  jmp alltraps
80105cff:	e9 a9 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d06:	6a 4e                	push   $0x4e
  jmp alltraps
80105d08:	e9 a0 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d0f:	6a 4f                	push   $0x4f
  jmp alltraps
80105d11:	e9 97 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d18:	6a 50                	push   $0x50
  jmp alltraps
80105d1a:	e9 8e f8 ff ff       	jmp    801055ad <alltraps>
...
80105d21:	6a 51                	push   $0x51
  jmp alltraps
80105d23:	e9 85 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d2a:	6a 52                	push   $0x52
  jmp alltraps
80105d2c:	e9 7c f8 ff ff       	jmp    801055ad <alltraps>
...
80105d33:	6a 53                	push   $0x53
  jmp alltraps
80105d35:	e9 73 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d3c:	6a 54                	push   $0x54
  jmp alltraps
80105d3e:	e9 6a f8 ff ff       	jmp    801055ad <alltraps>
...
80105d45:	6a 55                	push   $0x55
  jmp alltraps
80105d47:	e9 61 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d4e:	6a 56                	push   $0x56
  jmp alltraps
80105d50:	e9 58 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d57:	6a 57                	push   $0x57
  jmp alltraps
80105d59:	e9 4f f8 ff ff       	jmp    801055ad <alltraps>
...
80105d60:	6a 58                	push   $0x58
  jmp alltraps
80105d62:	e9 46 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d69:	6a 59                	push   $0x59
  jmp alltraps
80105d6b:	e9 3d f8 ff ff       	jmp    801055ad <alltraps>
...
80105d72:	6a 5a                	push   $0x5a
  jmp alltraps
80105d74:	e9 34 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d7b:	6a 5b                	push   $0x5b
  jmp alltraps
80105d7d:	e9 2b f8 ff ff       	jmp    801055ad <alltraps>
...
80105d84:	6a 5c                	push   $0x5c
  jmp alltraps
80105d86:	e9 22 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d8d:	6a 5d                	push   $0x5d
  jmp alltraps
80105d8f:	e9 19 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d96:	6a 5e                	push   $0x5e
  jmp alltraps
80105d98:	e9 10 f8 ff ff       	jmp    801055ad <alltraps>
...
80105d9f:	6a 5f                	push   $0x5f
  jmp alltraps
80105da1:	e9 07 f8 ff ff       	jmp    801055ad <alltraps>
...
80105da8:	6a 60                	push   $0x60
  jmp alltraps
80105daa:	e9 fe f7 ff ff       	jmp    801055ad <alltraps>
...
80105db1:	6a 61                	push   $0x61
  jmp alltraps
80105db3:	e9 f5 f7 ff ff       	jmp    801055ad <alltraps>
...
80105dba:	6a 62                	push   $0x62
  jmp alltraps
80105dbc:	e9 ec f7 ff ff       	jmp    801055ad <alltraps>
...
80105dc3:	6a 63                	push   $0x63
  jmp alltraps
80105dc5:	e9 e3 f7 ff ff       	jmp    801055ad <alltraps>
...
80105dcc:	6a 64                	push   $0x64
  jmp alltraps
80105dce:	e9 da f7 ff ff       	jmp    801055ad <alltraps>
...
80105dd5:	6a 65                	push   $0x65
  jmp alltraps
80105dd7:	e9 d1 f7 ff ff       	jmp    801055ad <alltraps>
...
80105dde:	6a 66                	push   $0x66
  jmp alltraps
80105de0:	e9 c8 f7 ff ff       	jmp    801055ad <alltraps>
...
80105de7:	6a 67                	push   $0x67
  jmp alltraps
80105de9:	e9 bf f7 ff ff       	jmp    801055ad <alltraps>
...
80105df0:	6a 68                	push   $0x68
  jmp alltraps
80105df2:	e9 b6 f7 ff ff       	jmp    801055ad <alltraps>
...
80105df9:	6a 69                	push   $0x69
  jmp alltraps
80105dfb:	e9 ad f7 ff ff       	jmp    801055ad <alltraps>
...
80105e02:	6a 6a                	push   $0x6a
  jmp alltraps
80105e04:	e9 a4 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e0b:	6a 6b                	push   $0x6b
  jmp alltraps
80105e0d:	e9 9b f7 ff ff       	jmp    801055ad <alltraps>
...
80105e14:	6a 6c                	push   $0x6c
  jmp alltraps
80105e16:	e9 92 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e1d:	6a 6d                	push   $0x6d
  jmp alltraps
80105e1f:	e9 89 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e26:	6a 6e                	push   $0x6e
  jmp alltraps
80105e28:	e9 80 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e2f:	6a 6f                	push   $0x6f
  jmp alltraps
80105e31:	e9 77 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e38:	6a 70                	push   $0x70
  jmp alltraps
80105e3a:	e9 6e f7 ff ff       	jmp    801055ad <alltraps>
...
80105e41:	6a 71                	push   $0x71
  jmp alltraps
80105e43:	e9 65 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e4a:	6a 72                	push   $0x72
  jmp alltraps
80105e4c:	e9 5c f7 ff ff       	jmp    801055ad <alltraps>
...
80105e53:	6a 73                	push   $0x73
  jmp alltraps
80105e55:	e9 53 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e5c:	6a 74                	push   $0x74
  jmp alltraps
80105e5e:	e9 4a f7 ff ff       	jmp    801055ad <alltraps>
...
80105e65:	6a 75                	push   $0x75
  jmp alltraps
80105e67:	e9 41 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e6e:	6a 76                	push   $0x76
  jmp alltraps
80105e70:	e9 38 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e77:	6a 77                	push   $0x77
  jmp alltraps
80105e79:	e9 2f f7 ff ff       	jmp    801055ad <alltraps>
...
80105e80:	6a 78                	push   $0x78
  jmp alltraps
80105e82:	e9 26 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e89:	6a 79                	push   $0x79
  jmp alltraps
80105e8b:	e9 1d f7 ff ff       	jmp    801055ad <alltraps>
...
80105e92:	6a 7a                	push   $0x7a
  jmp alltraps
80105e94:	e9 14 f7 ff ff       	jmp    801055ad <alltraps>
...
80105e9b:	6a 7b                	push   $0x7b
  jmp alltraps
80105e9d:	e9 0b f7 ff ff       	jmp    801055ad <alltraps>
...
80105ea4:	6a 7c                	push   $0x7c
  jmp alltraps
80105ea6:	e9 02 f7 ff ff       	jmp    801055ad <alltraps>
...
80105ead:	6a 7d                	push   $0x7d
  jmp alltraps
80105eaf:	e9 f9 f6 ff ff       	jmp    801055ad <alltraps>
...
80105eb6:	6a 7e                	push   $0x7e
  jmp alltraps
80105eb8:	e9 f0 f6 ff ff       	jmp    801055ad <alltraps>
...
80105ebf:	6a 7f                	push   $0x7f
  jmp alltraps
80105ec1:	e9 e7 f6 ff ff       	jmp    801055ad <alltraps>
...
80105ec8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ecd:	e9 db f6 ff ff       	jmp    801055ad <alltraps>
...
80105ed4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105ed9:	e9 cf f6 ff ff       	jmp    801055ad <alltraps>
...
80105ee0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105ee5:	e9 c3 f6 ff ff       	jmp    801055ad <alltraps>
...
80105eec:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ef1:	e9 b7 f6 ff ff       	jmp    801055ad <alltraps>
...
80105ef8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105efd:	e9 ab f6 ff ff       	jmp    801055ad <alltraps>
...
80105f04:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105f09:	e9 9f f6 ff ff       	jmp    801055ad <alltraps>
...
80105f10:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105f15:	e9 93 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f1c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105f21:	e9 87 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f28:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105f2d:	e9 7b f6 ff ff       	jmp    801055ad <alltraps>
...
80105f34:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105f39:	e9 6f f6 ff ff       	jmp    801055ad <alltraps>
...
80105f40:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105f45:	e9 63 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f4c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105f51:	e9 57 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f58:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105f5d:	e9 4b f6 ff ff       	jmp    801055ad <alltraps>
...
80105f64:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105f69:	e9 3f f6 ff ff       	jmp    801055ad <alltraps>
...
80105f70:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105f75:	e9 33 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f7c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105f81:	e9 27 f6 ff ff       	jmp    801055ad <alltraps>
...
80105f88:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105f8d:	e9 1b f6 ff ff       	jmp    801055ad <alltraps>
...
80105f94:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105f99:	e9 0f f6 ff ff       	jmp    801055ad <alltraps>
...
80105fa0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105fa5:	e9 03 f6 ff ff       	jmp    801055ad <alltraps>
...
80105fac:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105fb1:	e9 f7 f5 ff ff       	jmp    801055ad <alltraps>
...
80105fb8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105fbd:	e9 eb f5 ff ff       	jmp    801055ad <alltraps>
...
80105fc4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105fc9:	e9 df f5 ff ff       	jmp    801055ad <alltraps>
...
80105fd0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105fd5:	e9 d3 f5 ff ff       	jmp    801055ad <alltraps>
...
80105fdc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105fe1:	e9 c7 f5 ff ff       	jmp    801055ad <alltraps>
...
80105fe8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105fed:	e9 bb f5 ff ff       	jmp    801055ad <alltraps>
...
80105ff4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105ff9:	e9 af f5 ff ff       	jmp    801055ad <alltraps>
...
80106000:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106005:	e9 a3 f5 ff ff       	jmp    801055ad <alltraps>
...
8010600c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106011:	e9 97 f5 ff ff       	jmp    801055ad <alltraps>
...
80106018:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010601d:	e9 8b f5 ff ff       	jmp    801055ad <alltraps>
...
80106024:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106029:	e9 7f f5 ff ff       	jmp    801055ad <alltraps>
...
80106030:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106035:	e9 73 f5 ff ff       	jmp    801055ad <alltraps>
...
8010603c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106041:	e9 67 f5 ff ff       	jmp    801055ad <alltraps>
...
80106048:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010604d:	e9 5b f5 ff ff       	jmp    801055ad <alltraps>
...
80106054:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106059:	e9 4f f5 ff ff       	jmp    801055ad <alltraps>
...
80106060:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106065:	e9 43 f5 ff ff       	jmp    801055ad <alltraps>
...
8010606c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106071:	e9 37 f5 ff ff       	jmp    801055ad <alltraps>
...
80106078:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010607d:	e9 2b f5 ff ff       	jmp    801055ad <alltraps>
...
80106084:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106089:	e9 1f f5 ff ff       	jmp    801055ad <alltraps>
...
80106090:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106095:	e9 13 f5 ff ff       	jmp    801055ad <alltraps>
...
8010609c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801060a1:	e9 07 f5 ff ff       	jmp    801055ad <alltraps>
...
801060a8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801060ad:	e9 fb f4 ff ff       	jmp    801055ad <alltraps>
...
801060b4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801060b9:	e9 ef f4 ff ff       	jmp    801055ad <alltraps>
...
801060c0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801060c5:	e9 e3 f4 ff ff       	jmp    801055ad <alltraps>
...
801060cc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801060d1:	e9 d7 f4 ff ff       	jmp    801055ad <alltraps>
...
801060d8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801060dd:	e9 cb f4 ff ff       	jmp    801055ad <alltraps>
...
801060e4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801060e9:	e9 bf f4 ff ff       	jmp    801055ad <alltraps>
...
801060f0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801060f5:	e9 b3 f4 ff ff       	jmp    801055ad <alltraps>
...
801060fc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106101:	e9 a7 f4 ff ff       	jmp    801055ad <alltraps>
...
80106108:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010610d:	e9 9b f4 ff ff       	jmp    801055ad <alltraps>
...
80106114:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106119:	e9 8f f4 ff ff       	jmp    801055ad <alltraps>
...
80106120:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106125:	e9 83 f4 ff ff       	jmp    801055ad <alltraps>
...
8010612c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106131:	e9 77 f4 ff ff       	jmp    801055ad <alltraps>
...
80106138:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010613d:	e9 6b f4 ff ff       	jmp    801055ad <alltraps>
...
80106144:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106149:	e9 5f f4 ff ff       	jmp    801055ad <alltraps>
...
80106150:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106155:	e9 53 f4 ff ff       	jmp    801055ad <alltraps>
...
8010615c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106161:	e9 47 f4 ff ff       	jmp    801055ad <alltraps>
...
80106168:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010616d:	e9 3b f4 ff ff       	jmp    801055ad <alltraps>
...
80106174:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106179:	e9 2f f4 ff ff       	jmp    801055ad <alltraps>
...
80106180:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106185:	e9 23 f4 ff ff       	jmp    801055ad <alltraps>
...
8010618c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106191:	e9 17 f4 ff ff       	jmp    801055ad <alltraps>
...
80106198:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010619d:	e9 0b f4 ff ff       	jmp    801055ad <alltraps>
...
801061a4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801061a9:	e9 ff f3 ff ff       	jmp    801055ad <alltraps>
...
801061b0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801061b5:	e9 f3 f3 ff ff       	jmp    801055ad <alltraps>
...
801061bc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801061c1:	e9 e7 f3 ff ff       	jmp    801055ad <alltraps>
...
801061c8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801061cd:	e9 db f3 ff ff       	jmp    801055ad <alltraps>
...
801061d4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801061d9:	e9 cf f3 ff ff       	jmp    801055ad <alltraps>
...
801061e0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801061e5:	e9 c3 f3 ff ff       	jmp    801055ad <alltraps>
...
801061ec:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801061f1:	e9 b7 f3 ff ff       	jmp    801055ad <alltraps>
...
801061f8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801061fd:	e9 ab f3 ff ff       	jmp    801055ad <alltraps>
...
80106204:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106209:	e9 9f f3 ff ff       	jmp    801055ad <alltraps>
...
80106210:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106215:	e9 93 f3 ff ff       	jmp    801055ad <alltraps>
...
8010621c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106221:	e9 87 f3 ff ff       	jmp    801055ad <alltraps>
...
80106228:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010622d:	e9 7b f3 ff ff       	jmp    801055ad <alltraps>
...
80106234:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106239:	e9 6f f3 ff ff       	jmp    801055ad <alltraps>
...
80106240:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106245:	e9 63 f3 ff ff       	jmp    801055ad <alltraps>
...
8010624c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106251:	e9 57 f3 ff ff       	jmp    801055ad <alltraps>
...
80106258:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010625d:	e9 4b f3 ff ff       	jmp    801055ad <alltraps>
...
80106264:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106269:	e9 3f f3 ff ff       	jmp    801055ad <alltraps>
...
80106270:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106275:	e9 33 f3 ff ff       	jmp    801055ad <alltraps>
...
8010627c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106281:	e9 27 f3 ff ff       	jmp    801055ad <alltraps>
...
80106288:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010628d:	e9 1b f3 ff ff       	jmp    801055ad <alltraps>
...
80106294:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106299:	e9 0f f3 ff ff       	jmp    801055ad <alltraps>
...
801062a0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801062a5:	e9 03 f3 ff ff       	jmp    801055ad <alltraps>
...
801062ac:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801062b1:	e9 f7 f2 ff ff       	jmp    801055ad <alltraps>
...
801062b8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801062bd:	e9 eb f2 ff ff       	jmp    801055ad <alltraps>
...
801062c4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801062c9:	e9 df f2 ff ff       	jmp    801055ad <alltraps>
...
801062d0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801062d5:	e9 d3 f2 ff ff       	jmp    801055ad <alltraps>
...
801062dc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801062e1:	e9 c7 f2 ff ff       	jmp    801055ad <alltraps>
...
801062e8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801062ed:	e9 bb f2 ff ff       	jmp    801055ad <alltraps>
...
801062f4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801062f9:	e9 af f2 ff ff       	jmp    801055ad <alltraps>
...
80106300:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106305:	e9 a3 f2 ff ff       	jmp    801055ad <alltraps>
...
8010630c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106311:	e9 97 f2 ff ff       	jmp    801055ad <alltraps>
...
80106318:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010631d:	e9 8b f2 ff ff       	jmp    801055ad <alltraps>
...
80106324:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106329:	e9 7f f2 ff ff       	jmp    801055ad <alltraps>
...
80106330:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106335:	e9 73 f2 ff ff       	jmp    801055ad <alltraps>
...
8010633c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106341:	e9 67 f2 ff ff       	jmp    801055ad <alltraps>
...
80106348:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010634d:	e9 5b f2 ff ff       	jmp    801055ad <alltraps>
...
80106354:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106359:	e9 4f f2 ff ff       	jmp    801055ad <alltraps>
...
80106360:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106365:	e9 43 f2 ff ff       	jmp    801055ad <alltraps>
...
8010636c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106371:	e9 37 f2 ff ff       	jmp    801055ad <alltraps>
...
80106378:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010637d:	e9 2b f2 ff ff       	jmp    801055ad <alltraps>
...
80106384:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106389:	e9 1f f2 ff ff       	jmp    801055ad <alltraps>
...
80106390:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106395:	e9 13 f2 ff ff       	jmp    801055ad <alltraps>
...
8010639c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801063a1:	e9 07 f2 ff ff       	jmp    801055ad <alltraps>
...
801063a8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801063ad:	e9 fb f1 ff ff       	jmp    801055ad <alltraps>
...
801063b4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801063b9:	e9 ef f1 ff ff       	jmp    801055ad <alltraps>
...
801063c0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801063c5:	e9 e3 f1 ff ff       	jmp    801055ad <alltraps>
...
801063cc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801063d1:	e9 d7 f1 ff ff       	jmp    801055ad <alltraps>
...
801063d8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801063dd:	e9 cb f1 ff ff       	jmp    801055ad <alltraps>
...
801063e4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801063e9:	e9 bf f1 ff ff       	jmp    801055ad <alltraps>
...
801063f0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801063f5:	e9 b3 f1 ff ff       	jmp    801055ad <alltraps>
...
801063fc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106401:	e9 a7 f1 ff ff       	jmp    801055ad <alltraps>
...
80106408:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010640d:	e9 9b f1 ff ff       	jmp    801055ad <alltraps>
...
80106414:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106419:	e9 8f f1 ff ff       	jmp    801055ad <alltraps>
...
80106420:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106425:	e9 83 f1 ff ff       	jmp    801055ad <alltraps>
...
8010642c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106431:	e9 77 f1 ff ff       	jmp    801055ad <alltraps>
...
80106438:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010643d:	e9 6b f1 ff ff       	jmp    801055ad <alltraps>
...
80106444:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106449:	e9 5f f1 ff ff       	jmp    801055ad <alltraps>
...
80106450:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106455:	e9 53 f1 ff ff       	jmp    801055ad <alltraps>
...
8010645c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106461:	e9 47 f1 ff ff       	jmp    801055ad <alltraps>
...
80106468:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010646d:	e9 3b f1 ff ff       	jmp    801055ad <alltraps>
...
80106474:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106479:	e9 2f f1 ff ff       	jmp    801055ad <alltraps>
...
80106480:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106485:	e9 23 f1 ff ff       	jmp    801055ad <alltraps>
...
8010648c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106491:	e9 17 f1 ff ff       	jmp    801055ad <alltraps>
...
80106498:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010649d:	e9 0b f1 ff ff       	jmp    801055ad <alltraps>
...
801064a4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801064a9:	e9 ff f0 ff ff       	jmp    801055ad <alltraps>
...
801064b0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801064b5:	e9 f3 f0 ff ff       	jmp    801055ad <alltraps>
...
801064bc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801064c1:	e9 e7 f0 ff ff       	jmp    801055ad <alltraps>
...
80106514:	e8 87 bf ff ff       	call   801024a0 <kalloc>
...
80106532:	e8 99 de ff ff       	call   801043d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106623:	e8 c8 bc ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
80106683:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106686:	e8 f5 cf ff ff       	call   80103680 <cpuid>
...
80106784:	0f 84 c3 00 00 00    	je     8010684d <switchuvm+0xed>
  pushcli();
8010678a:	e8 91 da ff ff       	call   80104220 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010678f:	e8 6c ce ff ff       	call   80103600 <mycpu>
80106794:	89 c3                	mov    %eax,%ebx
80106796:	e8 65 ce ff ff       	call   80103600 <mycpu>
8010679b:	89 c7                	mov    %eax,%edi
8010679d:	e8 5e ce ff ff       	call   80103600 <mycpu>
...
8010683b:	5d                   	pop    %ebp
  popcli();
8010683c:	e9 1f da ff ff       	jmp    80104260 <popcli>
...
8010688b:	77 54                	ja     801068e1 <inituvm+0x71>
  mem = kalloc();
8010688d:	e8 0e bc ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801068a7:	e8 24 db ff ff       	call   801043d0 <memset>
...
801068db:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801068dc:	e9 8f db ff ff       	jmp    80104470 <memmove>
...
8010696d:	e8 ee af ff ff       	call   80101960 <readi>
...
801069f3:	e8 d8 d9 ff ff       	call   801043d0 <memset>
...
80106a24:	76 2a                	jbe    80106a50 <allocuvm+0xa0>
    mem = kalloc();
80106a26:	e8 75 ba ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106b6b:	e8 60 d8 ff ff       	call   801043d0 <memset>
...
80106c5d:	e8 0e d8 ff ff       	call   80104470 <memmove>
...
80106cb0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106cb6:	e8 e5 b7 ff ff       	call   801024a0 <kalloc>
...
80106ceb:	e8 00 b6 ff ff       	call   801022f0 <kfree>
      goto bad;
...
80106d8c:	e8 df d6 ff ff       	call   80104470 <memmove>
    len -= n;
    buf += n;
