...
int main(int argc, char *argv[])
{
  ...
  printf(1, "\n This program tests the correctness of your lab#1\n");
   d:	c7 44 24 04 fc 0d 00 	movl   $0xdfc,0x4(%esp)
  14:	00 
  ...
  51:	c7 44 24 04 30 0e 00 	movl   $0xe30,0x4(%esp)
  58:	00 
...
int exitWait(void) {
  ...
  e4:	c7 44 24 04 58 0c 00 	movl   $0xc58,0x4(%esp)
  eb:	00 
 ...
 112:	75 34                	jne    148 <exitWait+0xa8>
      printf(1, "\nThis is child with PID# %d and I will exit with status %d\n", getpid(), 0);
 114:	e8 91 06 00 00       	call   7aa <getpid>
 119:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 120:	00 
 121:	c7 44 24 04 1c 0c 00 	movl   $0xc1c,0x4(%esp)
 128:	00 
 ...
 145:	8d 76 00             	lea    0x0(%esi),%esi
	 printf(1, "\nThis is child with PID# %d and I will exit with status %d\n" ,getpid(), -1);
 148:	e8 5d 06 00 00       	call   7aa <getpid>
 14d:	c7 44 24 0c ff ff ff 	movl   $0xffffffff,0xc(%esp)
 154:	ff 
 155:	c7 44 24 04 1c 0c 00 	movl   $0xc1c,0x4(%esp)
 15c:	00 
 ...
 174:	e8 a9 05 00 00       	call   722 <exit>
	  printf(2, "\nError using fork\n");
 179:	c7 44 24 04 a8 0e 00 	movl   $0xea8,0x4(%esp)
 180:	00 
...
int waitPid(void){
 ...
 1a8:	c7 44 24 04 9c 0c 00 	movl   $0xc9c,0x4(%esp)
 1af:	00 
 ...
 1f9:	75 ea                	jne    1e5 <waitPid+0x45>
			printf(1, "\n This is a child process with PID# %d and I will exit with status %d\n", getpid(), getpid() + 4);
			exit(getpid() + 4);
		}
	}
 ...
 202:	8d 5d e0             	lea    -0x20(%ebp),%ebx
      sleep(5);
 205:	e8 b0 05 00 00       	call   7ba <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[3]);
 20a:	8b 75 f0             	mov    -0x10(%ebp),%esi
 20d:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 214:	00 
 ...
 25f:	e8 56 05 00 00       	call   7ba <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[1]);
 264:	8b 75 e8             	mov    -0x18(%ebp),%esi
 267:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 26e:	00 
 ...
 28d:	00 
 28e:	e8 9f 04 00 00       	call   732 <waitpid>
      printf(1, "\n This is the parent: Child# %d has exited with status %d\n",ret_pid, exit_status);
 293:	8b 55 e0             	mov    -0x20(%ebp),%edx
 296:	c7 44 24 04 60 0d 00 	movl   $0xd60,0x4(%esp)
 29d:	00 
 ...
 2b9:	e8 fc 04 00 00       	call   7ba <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[2]);
 2be:	8b 75 ec             	mov    -0x14(%ebp),%esi
 2c1:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 2c8:	00 
 ...
 2e7:	00 
 2e8:	e8 45 04 00 00       	call   732 <waitpid>
      printf(1, "\n This is the parent: Child# %d has exited with status %d\n",ret_pid, exit_status);
 2ed:	8b 55 e0             	mov    -0x20(%ebp),%edx
 2f0:	c7 44 24 04 60 0d 00 	movl   $0xd60,0x4(%esp)
 2f7:	00 
 ...
 313:	e8 a2 04 00 00       	call   7ba <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[0]);
 318:	8b 75 e4             	mov    -0x1c(%ebp),%esi
 31b:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 322:	00 
 ...
 341:	00 
 342:	e8 eb 03 00 00       	call   732 <waitpid>
      printf(1, "\n This is the parent: Child# %d has exited with status %d\n",ret_pid, exit_status);
 347:	8b 55 e0             	mov    -0x20(%ebp),%edx
 34a:	c7 44 24 04 60 0d 00 	movl   $0xd60,0x4(%esp)
 351:	00 
 ...
 36d:	e8 48 04 00 00       	call   7ba <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[4]);
 372:	8b 75 f4             	mov    -0xc(%ebp),%esi
 375:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 37c:	00 
 ...
 39b:	00 
 39c:	e8 91 03 00 00       	call   732 <waitpid>
      printf(1, "\n This is the parent: Child# %d has exited with status %d\n",ret_pid, exit_status);
 3a1:	8b 55 e0             	mov    -0x20(%ebp),%edx
 3a4:	c7 44 24 04 60 0d 00 	movl   $0xd60,0x4(%esp)
 3ab:	00 
...
int CELEBW02(void){
 ...
 418:	c7 44 24 04 9c 0d 00 	movl   $0xd9c,0x4(%esp)
 41f:	00 
 ...
 457:	e8 d6 02 00 00       	call   732 <waitpid>
 ...
 48b:	c7 44 24 04 dc 0d 00 	movl   $0xddc,0x4(%esp)
 492:	00 
 ...
 4ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(2, "wait() error");
 4b0:	c7 44 24 04 c8 0e 00 	movl   $0xec8,0x4(%esp)
 4b7:	00 
 ...
 4cc:	c3                   	ret    
    printf(2, "fork() error");
 4cd:	c7 44 24 04 bb 0e 00 	movl   $0xebb,0x4(%esp)
 4d4:	00 
 ...
 4ea:	e8 cb 02 00 00       	call   7ba <sleep>
    exit(1);
 ...
 615:	31 f6                	xor    %esi,%esi
{
 ...
 633:	e8 0a 01 00 00       	call   742 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 686:	e8 df 00 00 00       	call   76a <open>
  if(fd < 0)
 ...
 69b:	e8 e2 00 00 00       	call   782 <fstat>
  close(fd);
 6a0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 6a3:	89 c6                	mov    %eax,%esi
  close(fd);
 6a5:	e8 a8 00 00 00       	call   752 <close>
  return r;
...
0000073a <pipe>:
SYSCALL(pipe)
 73a:	b8 04 00 00 00       	mov    $0x4,%eax
 73f:	cd 40                	int    $0x40
 741:	c3                   	ret    

00000742 <read>:
SYSCALL(read)
 742:	b8 05 00 00 00       	mov    $0x5,%eax
 747:	cd 40                	int    $0x40
 749:	c3                   	ret    

0000074a <write>:
SYSCALL(write)
 74a:	b8 10 00 00 00       	mov    $0x10,%eax
 74f:	cd 40                	int    $0x40
 751:	c3                   	ret    

00000752 <close>:
SYSCALL(close)
 752:	b8 15 00 00 00       	mov    $0x15,%eax
 757:	cd 40                	int    $0x40
 759:	c3                   	ret    

0000075a <kill>:
SYSCALL(kill)
 75a:	b8 06 00 00 00       	mov    $0x6,%eax
 75f:	cd 40                	int    $0x40
 761:	c3                   	ret    

00000762 <exec>:
SYSCALL(exec)
 762:	b8 07 00 00 00       	mov    $0x7,%eax
 767:	cd 40                	int    $0x40
 769:	c3                   	ret    

0000076a <open>:
SYSCALL(open)
 76a:	b8 0f 00 00 00       	mov    $0xf,%eax
 76f:	cd 40                	int    $0x40
 771:	c3                   	ret    

00000772 <mknod>:
SYSCALL(mknod)
 772:	b8 11 00 00 00       	mov    $0x11,%eax
 777:	cd 40                	int    $0x40
 779:	c3                   	ret    

0000077a <unlink>:
SYSCALL(unlink)
 77a:	b8 12 00 00 00       	mov    $0x12,%eax
 77f:	cd 40                	int    $0x40
 781:	c3                   	ret    

00000782 <fstat>:
SYSCALL(fstat)
 782:	b8 08 00 00 00       	mov    $0x8,%eax
 787:	cd 40                	int    $0x40
 789:	c3                   	ret    

0000078a <link>:
SYSCALL(link)
 78a:	b8 13 00 00 00       	mov    $0x13,%eax
 78f:	cd 40                	int    $0x40
 791:	c3                   	ret    

00000792 <mkdir>:
SYSCALL(mkdir)
 792:	b8 14 00 00 00       	mov    $0x14,%eax
 797:	cd 40                	int    $0x40
 799:	c3                   	ret    

0000079a <chdir>:
SYSCALL(chdir)
 79a:	b8 09 00 00 00       	mov    $0x9,%eax
 79f:	cd 40                	int    $0x40
 7a1:	c3                   	ret    

000007a2 <dup>:
SYSCALL(dup)
 7a2:	b8 0a 00 00 00       	mov    $0xa,%eax
 7a7:	cd 40                	int    $0x40
 7a9:	c3                   	ret    

000007aa <getpid>:
SYSCALL(getpid)
 7aa:	b8 0b 00 00 00       	mov    $0xb,%eax
 7af:	cd 40                	int    $0x40
 7b1:	c3                   	ret    

000007b2 <sbrk>:
SYSCALL(sbrk)
 7b2:	b8 0c 00 00 00       	mov    $0xc,%eax
 7b7:	cd 40                	int    $0x40
 7b9:	c3                   	ret    

000007ba <sleep>:
SYSCALL(sleep)
 7ba:	b8 0d 00 00 00       	mov    $0xd,%eax
 7bf:	cd 40                	int    $0x40
 7c1:	c3                   	ret    

000007c2 <uptime>:
SYSCALL(uptime)
 7c2:	b8 0e 00 00 00       	mov    $0xe,%eax
 7c7:	cd 40                	int    $0x40
 7c9:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 809:	0f b6 92 f5 0e 00 00 	movzbl 0xef5(%edx),%edx
  }while((x /= base) != 0);
 ...
 84a:	e8 fb fe ff ff       	call   74a <write>
  while(--i >= 0)
 ...
 87e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 8b3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 8b6:	e8 8f fe ff ff       	call   74a <write>
 ...
 926:	e8 1f fe ff ff       	call   74a <write>
        putc(fd, c);
 ...
 940:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 943:	e8 02 fe ff ff       	call   74a <write>
  for(i = 0; fmt[i]; i++){
 ...
 99f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 9a1:	b8 ee 0e 00 00       	mov    $0xeee,%eax
 ...
 9d0:	e8 75 fd ff ff       	call   74a <write>
        while(*s != 0){
 ...
 a00:	e8 45 fd ff ff       	call   74a <write>
 ...
 a50:	e8 f5 fc ff ff       	call   74a <write>
        ap++;
...
free(void *ap)
{
 ...
 a61:	a1 fc 11 00 00       	mov    0x11fc,%eax
{
 ...
 aa7:	89 10                	mov    %edx,(%eax)
  freep = p;
 aa9:	a3 fc 11 00 00       	mov    %eax,0x11fc
}
 aae:	5b                   	pop    %ebx
 aaf:	5e                   	pop    %esi
 ab0:	5f                   	pop    %edi
 ...
 acf:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 ad2:	a3 fc 11 00 00       	mov    %eax,0x11fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 af9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 afc:	8b 1d fc 11 00 00    	mov    0x11fc,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b39:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 b3b:	3b 15 fc 11 00 00    	cmp    0x11fc,%edx
 ...
 b5a:	e8 53 fc ff ff       	call   7b2 <sbrk>
  if(p == (char*)-1)
 ...
 b6d:	e8 ee fe ff ff       	call   a60 <free>
  return freep;
 b72:	8b 15 fc 11 00 00    	mov    0x11fc,%edx
 ...
 b94:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 b97:	89 15 fc 11 00 00    	mov    %edx,0x11fc
      return (void*)(p + 1);
 ...
 bac:	eb e9                	jmp    b97 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 bae:	c7 05 fc 11 00 00 00 	movl   $0x1200,0x11fc
 bb5:	12 00 00 
    base.s.size = 0;
 bb8:	ba 00 12 00 00       	mov    $0x1200,%edx
    base.s.ptr = freep = prevp = &base;
 bbd:	c7 05 00 12 00 00 00 	movl   $0x1200,0x1200
 bc4:	12 00 00 
    base.s.size = 0;
 bc7:	c7 05 04 12 00 00 00 	movl   $0x0,0x1204
 bce:	00 00 00 
