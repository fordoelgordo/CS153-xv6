...
printint(int fd, int xx, int base, int sgn)
{
  ...
  write(fd, &c, 1);
    ...
    408a:	e8 fb fe ff ff       	call   3f8a <write>
  while(--i >= 0)
    ...
    40be:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  write(fd, &c, 1);
    40f6:	e8 8f fe ff ff       	call   3f8a <write>
  ...
  write(fd, &c, 1);
    ...
    4166:	e8 1f fe ff ff       	call   3f8a <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    4183:	e8 02 fe ff ff       	call   3f8a <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    4210:	e8 75 fd ff ff       	call   3f8a <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    4240:	e8 45 fd ff ff       	call   3f8a <write>
  ...
  write(fd, &c, 1);
    ...
    4290:	e8 f5 fc ff ff       	call   3f8a <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    439a:	e8 53 fc ff ff       	call   3ff2 <sbrk>
  if(p == (char*)-1)
