...
00000020 <printf>:
{
  ...
  40:	e8 55 03 00 00       	call   39a <write>
}
  ...
  55:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  5a:	c7 44 24 04 1c 04 00 	movl   $0x41c,0x4(%esp)
  61:	00 
  62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  69:	e8 b2 ff ff ff       	call   20 <printf>
  6e:	eb 12                	jmp    82 <forktest+0x32>
    if(pid == 0)
  ...
  8d:	8d 75 f4             	lea    -0xc(%ebp),%esi
  90:	74 17                	je     a9 <forktest+0x59>
  92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(wait(&exitstatus) < 0){
  98:	89 34 24             	mov    %esi,(%esp)
  9b:	e8 da 02 00 00       	call   37a <wait>
  a0:	85 c0                	test   %eax,%eax
  a2:	78 64                	js     108 <forktest+0xb8>
  for(; n > 0; n--){
  a4:	83 eb 01             	sub    $0x1,%ebx
  a7:	75 ef                	jne    98 <forktest+0x48>
  if(wait(&exitstatus) != -1){
  a9:	89 34 24             	mov    %esi,(%esp)
  ac:	e8 c9 02 00 00       	call   37a <wait>
  b1:	83 f8 ff             	cmp    $0xffffffff,%eax
  b4:	75 72                	jne    128 <forktest+0xd8>
  printf(1, "fork test OK\n");
  b6:	c7 44 24 04 4e 04 00 	movl   $0x44e,0x4(%esp)
  bd:	00 
  be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c5:	e8 56 ff ff ff       	call   20 <printf>
}
  ...
  f7:	e8 9e 02 00 00       	call   39a <write>
    exit(0);
 ...
 265:	31 f6                	xor    %esi,%esi
{
 ...
 283:	e8 0a 01 00 00       	call   392 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2d6:	e8 df 00 00 00       	call   3ba <open>
  if(fd < 0)
 ...
 2eb:	e8 e2 00 00 00       	call   3d2 <fstat>
  close(fd);
 2f0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2f3:	89 c6                	mov    %eax,%esi
  close(fd);
 2f5:	e8 a8 00 00 00       	call   3a2 <close>
  return r;
